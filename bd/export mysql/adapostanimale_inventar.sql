...
CREATE TABLE `inventar` (
  ...
  `id_provizie` int DEFAULT NULL,
  `id_adapost` int DEFAULT NULL,
  `cantitate` int DEFAULT NULL,
  PRIMARY KEY (`id_inventar`),
  KEY `id_provizie` (`id_provizie`),
  KEY `id_adapost` (`id_adapost`),
  CONSTRAINT `inventar_ibfk_1` FOREIGN KEY (`id_provizie`) REFERENCES `provizii` (`id_provizie`),
  CONSTRAINT `inventar_ibfk_2` FOREIGN KEY (`id_adapost`) REFERENCES `adapost` (`id_adapost`)
...
INSERT INTO `inventar` VALUES (1,1,1,20),(2,2,2,5),(3,3,3,15),(4,4,4,30),(5,5,5,8);
