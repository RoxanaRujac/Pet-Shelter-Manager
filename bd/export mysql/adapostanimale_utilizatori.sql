...
CREATE TABLE `utilizatori` (
  ...
  `parola_utilizator` varchar(255) NOT NULL,
  `email_utilizator` varchar(255) NOT NULL,
...
INSERT INTO `utilizatori` VALUES (1,'eu','euparola','eu@gmail.com'),(6,'eu','tuparola','eu@gmail'),(7,'bdj','dfv','fvfs'),(8,'bimbim','bambam','roxi123@rujac.ro'),(9,'roxana','nuetreabata','roxana@gmail.com');
